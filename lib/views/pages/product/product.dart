    ...
    productBar = new ProductBar(
      ...
      items: <ProductItem> [
        ProductItem(new ProductModel(
          id: 0,
          name: 'Hot Sale Fruncata Cooperi Mini กุหลาบหินนำเข้า ไม้อวบน้ำ Live Succulent Plant ราคาถูก ต้นไม้ ไม้ ประดับ ต้นไม้ ประดับ พรรณ ไม้',
        ...
        ProductItem(new ProductModel(
          id: 1,
          name: 'Hot Sale Senecio Rowleyanus Mini Buddha Pearl 4-5cm G Succulents กุหลาบหินนำเข้า ไม้อวบน้ำ.Imported Live Succulents plant ราคาถูก ต้นไม้ ไม้ ประดับ ต้นไม้ ประดับ พรรณ ไม้',
          type: 'สินค้าสำเร็จรูป',
          size: ['M'],
        ...
        ProductItem(new ProductModel(
          id: 2,
          name: 'Hot Sale Mini Plant ลิ้นมังกรแคระ กระถาง 4 นิ้ว ราคาถูก ต้นไม้ ไม้ ประดับ ต้นไม้ ประดับ พรรณ ไม้',
          type: 'สินค้าสำเร็จรูป',
          size: ['M'],
        ...
        ProductItem(new ProductModel(
          id: 3,
          name: 'เมล็ดดอกไม้สวย 100pcs/bag Mixed Lithops Seeds Rare Succulent Seeds Ass Flower Seeds Pseudotruncatella Living Stone Bonsai Mini Garden Plant ต้นไม้มงคล ต้นไม้ประดับ ต้นไม้มงคลแคระ ต้นไม้จิ๋วจริง ดอกไม้ปลูก บอนไซ ผักสวนครัว เมล็ดพันธุ์พืช',
          type: 'สินค้าสำเร็จรูป',
          size: ['S', 'M'],
        ...
        ProductItem(new ProductModel(
          id: 4,
          name: 'Senecio Rowleyanus Mini Buddha Pearl 4-5cm G Succulents กุหลาบหินนำเข้า ไม้อวบน้ำ.Imported Live Succulents plant',
          type: 'สินค้าสำเร็จรูป',
          size: ['M'],
        ...
        ProductItem(new ProductModel(
          id: 5,
          name: 'Crassula oblique "Gollum" Single 2 Inch G Succulents กุหลาบหินนำเข้า ไม้อวบน้ำ',
          type: 'สินค้าสำเร็จรูป',
          size: ['M', 'L'],
        ...
        ProductItem(new ProductModel(
          id: 6,
          name: 'ระถางต้นไม้หลากสีขนาด 10*10 ซม.Succulent and Cactus Plants Flower Pot Home Desk Garden Decor Size 10*10 cm',
          type: 'กระถาง',
          size: ['S', 'M'],
        ...
        ProductItem(new ProductModel(
          id: 7,
          name: 'New โปร ลดสุด 70% กุหลาบหินนำเข้าราคาพิเศษ กระถาง 2 นิ้ว G Succulents Super sale Set 2',
          type: 'สินค้าสำเร็จรูป',
          size: ['M'],
        ...
        ProductItem(new ProductModel(
          id: 8,
          name: 'Echeveria Jung In กระถาง 2 นิ้ว Gsucculents',
          type: 'สินค้าสำเร็จรูป',
          size: ['S'],
        ...
        ProductItem(new ProductModel(
          id: 9,
          name: 'G Succulents กระถางดินเผาทำมือ Clay Series BC005',
          type: 'กระถาง',
          size: ['S', 'M', 'L'],
        ...
        ProductItem(new ProductModel(
          id: 10,
          name: 'กระถางต้นไม้สีธรรมชาติ 3 ขนาด Succulent and Cactus Plants Flower Natural Pot Home Desk Garden Decor 3 Sizes',
          type: 'กระถาง',
          size: ['M', 'L'],
